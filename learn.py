...
model.add(LSTM(step,
              ...
              activation='tanh',
              stateful=True))
model.add(LSTM(step, stateful=True, return_sequences=True, activation='sigmoid'))
model.add(LSTM(step, stateful=True, return_sequences=False, activation='selu'))
...
model.save('data/model/envSoundCreater')
